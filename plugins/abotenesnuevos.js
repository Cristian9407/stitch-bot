      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            ...
            footer: {
              text: "🤖 Stitch-BotV6 | Powered by Baileys"
            },
            header: {
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            ...
            footer: {
              text: "🤖 Stitch-BotV6 | Test de Botones"
            },
            header: {
    ...
    const message = generateWAMessageFromContent(m.chat, {
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            body: {
              text: `🌙 *Stitch-BotV6 - Menú Principal*\n\n¡Hola! Soy Stitch-Bot, tu asistente virtual.\n\n${text || 'Selecciona una categoría para explorar:'}`
            },
            footer: {
              text: "🤖 Powered by Stitch-BotV6 | Baileys"
            },
            header: {
              title: "🌟 *BIENVENIDO A STITCH-BOT*",
