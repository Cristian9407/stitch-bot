...
4️⃣ Clona el repo:
\`\`\`bash
git clone https://github.com/Cristian9407/stitch-bot.git
cd Stitch-Botv6
npm install
npm start
\`\`\`
✨ ¡Listo! Stitch-BotV6 funcionará sin problemas.`,
...
2️⃣ En el panel, abrí la sección **"Servidores"** y elegí **"Crear servidor"**.  
   - En el *catálogo* buscá **"Stitch-BotV6"** (está listado como tipo "Bot de WhatsApp").  
...
✨ ¡Ya tenés Stitch-BotV6 funcionando en BoxmineWorld!`,
...
\`\`\`bash
npm install -g pm2
pm2 start main.js --name "StitchBot"
\`\`\``,
...
──────────────────────.`,
  ...
  "actualizar bot": `🔄 **ACTUALIZAR STITCH BOT**
...
📢 Canal: [https://whatsapp.com/channel/0029VbANyNhedEWlvJ3Y](https://whatsapp.com/channel/0029VbANyNuLo4hedEJ3Y)  
🌐 GitHub: [Stitch-Botv6](https://github.com/Cristian9407/stitch-bot.git)  
💬 Discord: cristian_cr 
📧 Email: Stitchbotv6@gmail.com`,

  "quien es tu creador": `👨‍💻 **CREADOR DE Stitch BOT**

🌙 *Stitch-BotV6* fue desarrollada por **Cristian**, experto en automatización e inteligencia artificial.
📱 WhatsApp: [wa.me/5493483466763](https://wa.me/593985807958)
🌐 GitHub: https://github.com/Cristian9407/stitch-bot.git`
};
