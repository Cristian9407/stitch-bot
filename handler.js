  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;Cristia 💎;;;\nFN:Cristian💎\nORG:Cristian 💎\nTITLE:\nitem1.TEL;waid=593985807958:+593 98 580 7958\nitem1.X-ABLabel:Cristian 💎\nX-WA-BIZ-DESCRIPTION:[◉] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:Cristian 💎\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, { contacts: { displayName: 'Cristian 💎', contacts: [{ vcard }] } }, { quoted: callmsg });
