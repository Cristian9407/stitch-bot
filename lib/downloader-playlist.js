...
if (!configContent.includes('Stitch-Botv6')) throw new Error('Handler bloqueado: Stitch-Botv6 no encontrado.');
...
╰─────°.🌙.°·─────`
        ...
        footer: { 
          text: "🌙 Stitch-Botv6 | Sistema de Descargas" 
        },
        nativeFlowMessage: {
          buttons: [
